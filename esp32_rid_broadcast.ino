/* -*- tab-width: 2; mode: c; -*-
 * 
 * ESP32 Remote ID Broadcast Example
 * 
 * This sketch broadcasts Remote ID signals using WiFi beacon mode
 * on an ESP32. It simulates a drone flying in a pattern around
...
void setup() {
  ...
  // Set UAV ID
  strcpy(utm_parameters.UAV_id, "TEST-UAV-001");
  
  // Set flight description
  strcpy(utm_parameters.flight_desc, "Test Flight");
